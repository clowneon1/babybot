...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        em = discord.Embed(title="Help", description="A discord.py multi-use bot, with music and administrative capabilities. [Source code](https://github.com/Xephire/utils-bot-rewrite)", colour=discord.Color.purple())
        ...
        em.add_field(name="Queue", value="Shows the queue")
